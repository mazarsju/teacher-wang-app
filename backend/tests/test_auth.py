...
class TestProtectedRoutes(unittest.TestCase):
    ...
    def test_domain_routes_unauthorized_without_header(self):
        for method, path in (
            ...
            ("get", "/hsk-level"),
            ("get", "/hsk-level-light"),
            ("get", "/grammar-points-light"),
            ("get", "/grammar-points/1"),
            ("get", "/writing-practices"),
            ("get", "/token-usage"),
            ("get", "/anki/status"),
            ("post", "/database/export"),
            ("get", "/listening-practices-light"),
            ("get", "/listening-practices/1"),
            ...
            ("post", "/listening-practices/listening-family-size/progress"),
        ):
